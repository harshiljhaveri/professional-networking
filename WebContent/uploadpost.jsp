      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold">Upload Your Post Here</h1>
           </div>
        </div>
      </div>
    </div>  
...
        <form method="post" action="insertpost.jsp">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="text-black">Topic</label> 
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <label class="text-black">Post</label> 
		          <textarea id="post" name="post" placeholder="Enter your matter here.." style="height:400px"></textarea>
                </div>
              </div>
